arrows = document.querySelectorAll(('.slider-image .arrow'))

// console.log(arrows[0], arrows[1])

prev_image_arrow = arrows[0]
next_image_arrow = arrows[1]

mob_images = ['mob_1.jpg', 'mob_2.png', 'mob_3.png']
mob_names = ['Эндермен', 'Скелет', 'Зомби']
mob_texts = ['Большой и злой игровой моб в Minecraft. Его тяжело убить и он умеет телепортироваться',
